...
#ifndef __EPD2IN13_CPP
#define __EPD2IN13_CPP
...
const unsigned char lut_bw_2in13d[] = {
    0x40, 0x17, 0x00, 0x00, 0x00, 0x02, 0x90, 0x0F, 0x0F, 0x00, 0x00,
    0x03, 0x40, 0x0A, 0x01, 0x00, 0x00, 0x01, 0xA0, 0x0E, 0x0E, 0x00,
...
int EPD_Init_2in13() {
  ...
  if (EPD2in13V == 1) {
    ...
    EPD_Send_3(
        0x01, 249, 0,
        0); // DRIVER_OUTPUT_CONTROL: LO(h-1), HI(h-1), GD = 0; SM = 0; TB = 0;
    ...
    EPD_Send_3(0x04, lut_full_2in3v2[71], lut_full_2in3v2[72],
               lut_full_2in3v2[73]);
...
int EPD_Init_2in13_V3() {
  ...
  EPD_Send_3(0x04, WS_20_30_2IN13_V3[155], WS_20_30_2IN13_V3[156],
             WS_20_30_2IN13_V3[157]);
...
bool EPD_2IN13_V3_Show() {
  ...
  return success & EPD_WaitUntilIdle();
}
...
int EPD_2IN13B_V3_Init(void) {
  ...
  EPD_WaitUntilIdle(); // waiting for the electronic paper IC to release the
                       // idle signal
...
bool EPD_2IN13B_V3_Show() {
  ...
  delay(2);
  bool success = EPD_WaitUntilIdle(200);

  EPD_Send_1(0X50, 0xf7);
  EPD_SendCommand(0X02);          // power off
  success &= EPD_WaitUntilIdle(); // waiting for the electronic paper IC to
...
int EPD_Init_2in13d() {
  ...
  EPD_Send_1(
      0x30,
      0x3a); // PLL_SETTINGS: 3a 100HZ, 29 150Hz, 39 200HZ, 31 171HZ, 3c 50hz
