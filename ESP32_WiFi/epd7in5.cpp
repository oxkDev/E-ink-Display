...
#ifndef __EPD7IN5_CPP
#define __EPD7IN5_CPP
...
bool EPD_7IN5_V2_Show(void) {
  ...
  bool success = EPD_7in5_V2_Readbusy();

  // Enter sleep mode
  EPD_SendCommand(0X02); // power off
  success &= EPD_7in5_V2_Readbusy();
...
int EPD_7in5_V2_init() {
  ...
  EPD_7IN5_V2_LUT(LUT_VCOM_7IN5_V2, LUT_WW_7IN5_V2, LUT_BW_7IN5_V2,
