...
#ifndef __EPD4IN2_CPP
#define __EPD4IN2_CPP
...
int EPD_Init_4in2() {
  ...
  EPD_Send_4(0x61, 1, 144, 1,
             44);         // RESOLUTION_SETTING: HI(W), LO(W), HI(H), LO(H)
  EPD_Send_1(0x82, 0x12); // VCM_DC_SETTING
  EPD_Send_1(0x50, 0x97); // VCOM_AND_DATA_INTERVAL_SETTING: VBDF 17|D7 VBDW 97
                          // VBDB 57  VBDF F7  VBDW 77  VBDB 37  VBDR B7
...
bool EPD_4IN2B_V2_Show(void) {
  ...
  if (flag == 0) {
    ...
    EPD_SendData(0xF7);
    EPD_SendCommand(0x20);
    success = EPD_WaitUntilIdle_high();
